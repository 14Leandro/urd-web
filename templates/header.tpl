                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="#">Reserva División</a></li>
                                    <li><a class="dropdown-item" href="#">Quinta División</a></li>
                                    <li><a class="dropdown-item" href="#">Sexta División</a></li>
                                </ul>
                            </li> 
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="#">7ma. División</a></li>
                                    <li><a class="dropdown-item" href="#">8va. División</a></li>
                                    <li><a class="dropdown-item" href="#">9na. División</a></li>
                                    <li><a class="dropdown-item" href="#">10ma. División</a></li>
                                    <li><a class="dropdown-item" href="#">11ma. División</a></li>                                    
                                </ul>
                            </li> 
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="#">Sub-15 Masculino</a></li>                                   
                                </ul>
                            </li> 
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
